	...
	<form method="post" name="modifyAccountForm" action="modify_account.asp" target="hidden_frame">
		...
		<table width="90%" class="table well aidisk_table" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td><input class="input" name="new_account" id="new_account" type="text" maxlength="20"
			...
			<tr>
				...
				<td><input class="input" name="new_password" id="new_password" type="password" maxlength="20"
						style="width: 150px;"></td>
			</tr>
			<tr>
				<th>
				...
				<td><input class="input" name="confirm_password" id="confirm_password" maxlength="20" type="password"
						style="width: 150px;"></td>
			</tr>
			<tr>
				<th colspan="2" style="text-align: center"><input name="button" type="button" class="btn btn-primary"
						onclick="applyRule();" value="<#CTL_modify#>"></th>
			</tr>
		</table>
	</form>
</body>
