		...
		<table width="100%" class="table well aidisk_table" cellpadding="0" cellspacing="0">
			<thead>
				<tr>
					<td>
						<b>
							<#AddFolderTitle#>&nbsp;<#in#>&nbsp;<span id="poolName"></span>
						</b>
					</td>
					<td style="text-align: right">
						<a href="javascript:void(0)" onclick="parent.hidePop('OverlayMask');"><i
								class="if if-btn-minus"></i></a>
					</td>
				</tr>
			</thead>
			<tr>
			...
			<tr>
				<th colspan="2" style="text-align: center;"><input id="Submit" type="button" class="btn btn-primary"
						style="width: 170px;" value="<#CTL_add#>"></th>
			</tr>
		</table>
	</form>
</body>
