                                        ...
                                        <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                            <tr>
                                                <td style="border-top: 0 none; padding-bottom: 0px;">
                                                    <textarea rows="21" class="span12" style="height:377px; font-family:'Courier New', Courier, mono; font-size:13px;" readonly="readonly" wrap="off" id="textarea"><% nvram_dump("frpc.log",""); %></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left; padding-bottom: 0px;">
                                                    ...
                                                    <input type="button" onClick="location.href='frpc.log'" value="<#CTL_onlysave#>" class="btn btn-success btn-savelog" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
