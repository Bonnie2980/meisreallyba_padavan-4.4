    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/iptv.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            <input type="hidden" name="current_page" value="iptv.asp">
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                ...
                                                <tr>
                                                    <th width="50%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6, 6);"><#RouterConfig_IPTV_itemname#>:</a>
                                                    </th>
                                                    <td>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                ...
                                                <tr>
                                                    <th colspan="2" style="background-color: #E3E3E3;">
                                                        <#IPTVMulticast#> - IGMP/MLD Snooping
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th width="50%">
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr id="row_storm_ucast">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this, 6, 7);"><#RouterConfig_GWMulticast_unknownUni_itemname#></a>
                                                    </th>
                                                    <td>
