									...
									<div class="round_bottom">
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
												<tr>
													<th>frpc<#running_status#></th>
													<td id="frpc_status" colspan="2"></td>
												</tr>
												<tr>
													<th>frps<#running_status#></th>
													<td id="frps_status" colspan="2"></td>
												</tr>
												<tr>
													<th width="30%">
														<a class="help_tooltip" href="javascript: void(0)" onmouseover="openTooltip(this, 26, 9);">启用frpc</a>
													</th>
													<td>
												...
												<tr>
													<th width="30%">
														<a class="help_tooltip" href="javascript: void(0)" onmouseover="openTooltip(this, 26, 9);">启用frps</a>
													</th>
													<td>
												...
												<tr id="row_post_wan_script">
													<td colspan="2">
														...
														<a href="javascript:spoiler_toggle('script2')"><span>frp脚本-请自行配置脚本里的相关参数</span></a>
														<div id="script2">
