...
<head>
    ...
    <script>
        ...
        function switchPage(id) {
            if (id == "tab_bw_rt")
                location.href = "/trafficmonitor_realtime.asp";
            else if (id == "tab_tr_dy")
                location.href = "/trafficmonitor_daily.asp#DY";
            else if (id == "tab_tr_mo")
                location.href = "/trafficmonitor_daily.asp#MO";
            return false;
        }
                                ...
                                <div class="round_bottom">
                                    <div class="row-fluid">
                                        ...
                                        <div align="right" style="margin: 3px 8px 0px 0px;">
                                            <select id="sel_netif" style="width: 200px; margin-bottom: 5px;"
                                                onchange="tabSelect(this.value);">
                                            </select>
                                        </div>

                                        <div style="margin-bottom: 0px; margin: -36px 0px 0px 0px;">
                                            <ul id="tabs" class="nav nav-tabs">
                                                <li><a href="javascript:void(0)" id="tab_bw_rt">
                                                        <#menu4_2_1#>
                                                    </a></li>
                                                <li class="active"><a href="javascript:void(0)" id="tab_bw_24">
                                                        <#menu4_2_2#>
                                                    </a></li>
                                                <li><a href="javascript:void(0)" id="tab_tr_dy">
                                                        <#menu4_2_3#>
                                                    </a></li>
                                                <li><a href="javascript:void(0)" id="tab_tr_mo">
                                                        <#menu4_2_4#>
                                                    </a></li>
                                            </ul>
                                        </div>
                                            ...
                                            <table style="width: 100%; margin-top: 6px; margin-bottom: 6px;">
                                                <tr>
                                                    <td width="100%" align="center" style="text-align: center">
                                                        <div id="net_chart" style="width: 670px; padding-left: 5px;">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" align="center" valign="top"
                                                    style="text-align:right;font-weight: bold;"><span
                                                        id="rx-current"></span></td>
                                                <td width="20%" align="center" valign="top" style="text-align:right"
                                                    id="rx-avg"></td>
                                                <td width="20%" align="center" valign="top" style="text-align:right"
                                                    id="rx-max"></td>
                                                <td width="20%" align="center" valign="top" style="text-align:right"
