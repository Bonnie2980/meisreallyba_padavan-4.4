...
<body onload="initial();">
    ...
    <div class="wrapper">
        ...
        <form method="post" action="upgrade.cgi" name="form" target="hidden_frame" enctype="multipart/form-data">
            <input type="hidden" name="current_page" value="upgrade.asp">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="alert alert-info" style="margin: 10px;">
                                                ...
                                                <ol>
                                                    ...
                                                    <li><#FW_desc6#></li>
                                                    <li>
                                                        固件失败日志提示:Firmware update: Firmware image is corrupted!
                                                        Please check free space in /tmp!
                                                        请点击右边按钮，临时增加tmp空间，再上传固件即可！
                                                        <input id="bingtmp" class="btn btn-success" style="width:50px;display:none;" type="button" name="bingtmp" value="扩大/tmp" onclick="submitInternet('bigtmp');" />
                                                    </li>
                                                </ol>
                                            </div>
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="input" value="<% nvram_get_x("", "productid"); %>" readonly="1" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <td>
                                                        <input type="text" name="firmver" class="input" value="<% nvram_get_x("",  " firmver_sub"); %>" readonly="1" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <center>
                                                            <input type="button" name="button" class="btn btn-primary" style="width: 219px;" onclick="fwUpload();" value="<#CTL_upload#>" />
                                                        </center>
                                                    </td>
                                                </tr>
                                            </table>
