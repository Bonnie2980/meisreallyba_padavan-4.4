    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/dmz.asp";
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="input-append">
                                                            ...
                                                            <button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);" title="Select the IP of LAN clients.">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr>
                                                    <th width="50%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,7,21);"><#IPConnection_BattleNet_itemname#></a>
                                                    </th>
                                                    <td>
