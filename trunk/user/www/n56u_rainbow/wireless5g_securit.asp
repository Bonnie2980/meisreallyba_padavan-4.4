    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/wireless5g_securit.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            <input type="hidden" name="current_page" value="wireless5g_securit.asp">
                                            ...
                                            <table class="table">
                                                <tr>
                                                    <td style="margin-top: 10px; border-top: 0 none;">
                                                        <input class="btn btn-info" type="button" value="<#GO_2G#>" onclick="location.href='wireless2g_security.asp';" />
                                                    </td>
