...
<head>
    ...
    <script>
        ...
        function applyRule() {
            ...
            document.form.current_page.value = "/static.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            <input type="hidden" name="current_page" value="static.asp">
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table table-list" id="GWStaticList_Block">
                                                ...
                                                <tr>
                                                    <th width="28%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,1);"><#RouterConfig_GWStaticIP_itemname#>
                                                        </a>
                                                    </th>
                                                    <th width="22%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,2);"><#RouterConfig_GWStaticMask_itemname#>
                                                        </a>
                                                    </th>
                                                    <th width="22%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,3);"><#RouterConfig_GWStaticGW_itemname#>
                                                        </a>
                                                    </th>
                                                    <th width="10%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,4);"><#RouterConfig_GWStaticMT_itemname#>
                                                        </a>
                                                    </th>
                                                    <th width="13%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,5);"><#RouterConfig_GWStaticIF_itemname#>
                                                        </a>
                                                    </th>
                                                    <th width="5%">&nbsp;</th>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="text" maxlength="15" class="span12" size="12" name="sr_ipaddr_x_0" value='<% nvram_get_x("", "sr_ipaddr_x_0"); %>' onKeyPress="return is_ipaddr(this,event);" />
                                                    </td>
                                                    <td>
                                                        <input type="text" maxlength="15" class="span12" size="12" name="sr_netmask_x_0" value='<% nvram_get_x("", "sr_netmask_x_0"); %>' onKeyPress="return is_ipaddr(this,event);" />
                                                    </td>
                                                    <td>
                                                        <input type="text" maxlength="15" class="span12" size="12" name="sr_gateway_x_0" value='<% nvram_get_x("", "sr_gateway_x_0"); %>' onKeyPress="return is_ipaddr(this,event);" />
                                                    </td>
                                                    <td>
                                                        <input type="text" maxlength="3" class="span12" size="1" name="sr_matric_x_0" value='<% nvram_get_x("", " sr_matric_x_0"); %>' onkeypress="return is_number(this,event);" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <button class="btn" type="submit" onClick="return GWStatic_markGroup(this, 64, ' Add ');" name="GWStatic2">
