...
<body onload="initial();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            ...
            <input type="hidden" name="current_page" value="wol.asp">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="395px" style="border-top: 0 none; ">
                                                        <input
                                                            style="float: left; margin-right: 5px; font-family: monospace"
                                                            id="wol_mac" type="text" maxlength="17" class="span12 mac"
                                                            size="15" name="wol_mac" value="<% nvram_get_x("","
                                                            wol_mac_last"); %>"/>
                                                    </td>
                                                    <td style="border-top: 0 none; ">
                                                        <input type="button" id="wol_btn" class="btn btn-primary"
                                                            value="<#WOL_Wake_up#>" />
