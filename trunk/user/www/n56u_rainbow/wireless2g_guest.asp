...
function applyRule(){
	if(validForm()){
		...
		document.form.current_page.value = "/wireless2g_guest.asp";
...
<div class="wrapper">
    ...
    <input type="hidden" name="current_page" value="wireless2g_guest.asp">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td id="col_goto5" width="50%" style="margin-top: 10px; border-top: 0 none;">
                                                <input type="button" class="btn btn-info" name="goto5" value="<#GO_5G#>" onclick="location.href='wireless5g_guest.asp';">
                                            </td>
                                            <td style="border-top: 0 none;">
