...
<head>
    ...
    <script>
        ...
        function applyRule() {
            ...
            document.form.current_page.value = "sqm.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            ...
            <input type="hidden" name="current_page" value="sqm.asp">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="box well grad_colour_dark_blue">
                                    <h2 class="box_head round_top">SQM QoS - <#menu5_37#>
                                    </h2>
                                    <div class="round_bottom">
                                        ...
                                        <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table"
                                            ...
                                            <tr>
                                                <th width="32%">宽带下载速度 (<span class="label label-info">kbit/s</span>)
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th width="32%">宽带上传速度 (<span class="label label-info">kbit/s</span>)
                                                </th>
                                                <td>
                                                    <input type="text" maxlength="10" class="input" size="10" id="sqm_up_speed" name="sqm_up_speed" value="<% nvram_get_x(""," sqm_up_speed"); %>"/>
                                                </td>
                                                <td>
                                                    &nbsp;<span style="color:#888;">测速的80-95％，1 Mbps = 1024 kbit/s需填写小于下载速度的值</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>启用日志</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <span style="display: inline-block; width:68px;">带宽</span>:<input type="text" class="span2"
                            style="margin: 1px 5px;" id="bw_in_Mbps" value="10">Mbps
                    </div>
                    <div>
                        <span style="display: inline-block; width:68px;">百分比</span>:<input type="text" class="span2"
                            style="margin: 1px 5px;" id="bw_percent" value="95"> %
                    </div>
                    <div>
                        <span style="display: inline-block; width:68px;">结果</span>:<input type="text" readonly
                            class="span2" style="margin: 1px 5px;" id="bw_result" value=""> kbit/s
                    </div>
                </div>
