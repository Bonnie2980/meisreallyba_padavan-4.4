    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/tweaks.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            <input type="hidden" name="current_page" value="tweaks.asp">
                                ...
                                <div class="box well grad_colour_dark_blue">
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_fn2_actions" style="display:none;">
                                                <tr>
                                                    <th colspan="2" style="background-color: #E3E3E3;">
                                                        <#TweaksFN2Action#>
                                                    </th>
                                                ...
                                                <tr id="row_eth_phy_led0">
                                                    ...
                                                    <td>
                                                        <select name="ether_led0" class="input" style="width: 320px;">
                                                            ...
                                                            <option value="11" <% nvram_match_x("", "ether_led0" , "11" ,"selected"); %>><#btn_Disable#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_eth_phy_led1">
                                                    ...
                                                    <td>
                                                        <select name="ether_led1" class="input" style="width: 320px;">
                                                            ...
                                                            <option value="11" <% nvram_match_x("", "ether_led1" , "11" ,"selected"); %>><#btn_Disable#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                </tr>
