    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/wireless5g_guest.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" action="/start_apply.htm" target="hidden_frame">
            ...
            <input type="hidden" name="current_page" value="wireless5g_guest.asp">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                ...
                                                <tr id="row_guest_1" style="display:none;">
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline"><input type="checkbox" class="input" name="wl_guest_date_x_Mon"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Mon#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" class="input" name="wl_guest_date_x_Tue"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Tue#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" class="input" name="wl_guest_date_x_Wed"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Wed#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" class="input" name="wl_guest_date_x_Thu"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Thu#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" class="input" name="wl_guest_date_x_Fri"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Fri#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr id="row_guest_3" style="display:none;">
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline"><input type="checkbox" class="input" name="wl_guest_date_x_Sat"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sat#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" class="input" name="wl_guest_date_x_Sun"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sun#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr id="row_guest_5" style="display:none;">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="32" class="input" size="32" name="wl_guest_ssid" value=""
                                            ...
                                            <table class="table">
                                                <tr>
                                                    <td width="50%" style="margin-top: 10px; border-top: 0 none;">
                                                        <input type="button" class="btn btn-info" value="<#GO_2G#>" onclick="location.href='wireless2g_guest.asp';">
                                                    </td>
                                                    <td style="border-top: 0 none;">
