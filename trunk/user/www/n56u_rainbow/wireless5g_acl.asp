	...
	<script>
		...
		function applyRule() {
			if (prevent_lock()) {
				...
				document.form.current_page.value = "/wireless5g_acl.asp";
...
<body onload="initial();">
	...
	<div class="wrapper">
		...
		<form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
			<input type="hidden" name="current_page" value="wireless5g_acl.asp">
			<input type="hidden" name="next_page" value="wireless5g_securit.asp">
												...
												<tr>
													<td width="35%">
														...
														<div class="input-append">
															...
															<button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);" title="Select the MAC of WiFi clients">
													...
													<td width="5%">
														<button class="btn" style="max-width: 219px" type="submit" onclick="return markGroupACL(this, 32, ' Add ');" name="ACLList2" value="<#CTL_add#>" size="12">
											...
											<table class="table">
												<tr>
													<td width="50%" style="margin-top: 10px; border-top: 0 none;">
														<input class="btn btn-info" type="button" value="<#GO_2G#>" onclick="location.href='wireless2g_acl.asp';">
													</td>
													<td style="border-top: 0 none;">
