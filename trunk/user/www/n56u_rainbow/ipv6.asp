    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/ipv6.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            <input type="hidden" name="current_page" value="ipv6.asp">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_ip6_sit" style="display:none;">
                                                ...
                                                <tr id="row_ip6_sit_mtu">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" style="width: 40px;" class="input" size="4" name="ip6_sit_mtu" value="<% nvram_get_x("", "ip6_sit_mtu"); %>" onkeypress="return is_number(this,event);" onblur="return
                                                        validate_range(this, 1280, 1480);"/>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="row_ip6_lan_pool" style="display:none;">
                                                    ...
                                                    <td align="left">
                                                        <span class="input-prepend">
                                                            ...
                                                            <input type="text" name="ip6_lan_sfps_fake" class="ip6_residual" size="4" maxlength="4" onkeypress="return is_string(this,event);" onblur="return validate_ip6_part(this);" />
                                                            &nbsp;&nbsp;-&nbsp;&nbsp;
                                                        </span>
                                                        <span class="input-prepend">
                                                            <span class="add-on">::</span>
                                                            <input type="text" name="ip6_lan_sfpe_fake" class="ip6_residual" size="4" maxlength="4" onkeypress="return is_string(this,event);" onblur="return validate_ip6_part(this);" />
                                                        </span>
                                                    </td>
                                                </tr>
