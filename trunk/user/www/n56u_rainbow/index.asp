...
<body onunload="return unload_body();">
	...
	<div class="wrapper">
		...
		<iframe name="hidden_frame" id="hidden_frame" width="0" height="0" frameborder="0" scrolling="no"
							...
							<div class="well" style="height: 570px; padding-left: 18px;">
								...
								<table id="tblshortcut" class="table table-big" style="margin-top: 12px;">
									<tbody>
										<tr id="row_internet">
											<td width="30%">
												<a id="linkInternet" href="/device-map/internet.asp"
													target="statusframe" style="outline:0;">
													<i id="iconInternet" class="if if-shortcut-internet"
														onclick="clickEvent(this);">
													</i>
												</a>
												<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
												<div class="badge-container">
													<div id="internetStatus" class="badge badge-circle"></div>
												</div>
												<div class="arrow-right" id="arrow-internet">
													<i class="if if-color-smoke if-arrow-right" style="font-size: 2.3em;"></i>
												</div>
											</td>
										</tr>
										<tr id="row_radio">
											<td width="30%">
												<a href="device-map/router2g.asp" target="statusframe" style="outline:0;">
													<i id="iconRouter" class="if if-shortcut-wifisetting" onclick="clickEvent(this);"></i>
												</a>
												<div class="badge-container">
													<div id="wl_securitylevel_span" class="badge badge-circle"></div>
												</div>
										...
										<tr>
											<td>
												<a id="clientStatusLink" href="device-map/clients.asp" target="statusframe" style="outline:0;">
													<i id="iconClient" class="if if-shortcut-deviceslist" onclick="clickEvent(this);"></i>
												</a>
												<div class="badge-container">
										...
										<tr id="row_usb_port1">
											<td width="30%">
												<i id="deviceIcon_0" class="if if-shortcut-usbdevice"></i>
												<div class="badge-container">
													<div id="deviceDec_0" class="badge badge-circle"></div>
												</div>
										...
										<tr id="row_usb_port2" style="display:none">
											<td width="30%">
												<i id="deviceIcon_1" class="if if-shortcut-usbdevice"></i>
												<div class="badge-container">
													<div id="deviceDec_1" class="badge badge-circle"></div>
												</div>
										...
										<tr id="row_ata_pool" style="display:none">
											<td width="30%">
												<i id="sataIcon" class="if if-shortcut-harddisk"></i>
												<div class="badge-container">
													<div id="sataDec" class="badge badge-circle"></div>
												</div>
										...
										<tr id="row_mmc_slot" style="display:none">
											<td width="30%">
												<i id="cardIcon" class="if if-shortcut-tfcard"></i>
												<div class="badge-container">
													<div id="cardDec" class="badge badge-circle"></div>
												</div>
