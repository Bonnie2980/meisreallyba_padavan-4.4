...
<body onload="initial();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" action="apply.cgi" class="form_thin">
            <input type="hidden" name="current_page" value="logs.asp">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                <tr>
                                                    <td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
                                                        ...
                                                        </b><span class="alert alert-info"
                                                            style="margin-left: 10px; padding-top: 4px; padding-bottom: 4px;"
                                                            id="system_time"></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
                                                        <textarea rows="21" class="span12"
                                                            ...
                                                            id="textarea"><% nvram_dump("syslog.log",""); %></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="15%" style="text-align: left; padding-bottom: 0px;">
                                                        <input type="submit" onClick="clearLog();" value="<#CTL_clear#>"
                                                            class="btn btn-info" style="width: 170px">
                                                    </td>
                                                    <td width="15%" style="text-align: left; padding-bottom: 0px;">
                                                        <input type="button" onClick="location.href='syslog.txt'"
                                                            value="<#CTL_onlysave#>" class="btn btn-success"
                                                            style="width: 170px">
                                                    </td>
