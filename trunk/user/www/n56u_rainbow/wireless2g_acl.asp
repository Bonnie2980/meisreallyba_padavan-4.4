	...
	<script>
		...
		function applyRule() {
			if (prevent_lock()) {
				...
				document.form.current_page.value = "/wireless2g_acl.asp";
...
<body onload="initial();">
	...
	<div class="wrapper">
		...
		<form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
			<input type="hidden" name="current_page" value="wireless2g_acl.asp">
										...
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table table-list" id="ACLList_Block">
												...
												<tr>
													...
													<td width="5%">
														<button class="btn" style="max-width: 219px" type="submit" onclick="return markGroupACL(this, 32, ' Add ');" name="rt_ACLList2" value="<#CTL_add#>" size="12">
											...
											<table class="table">
												<tr>
													<td id="col_goto5" width="50%" style="margin-top: 10px; border-top: 0 none;">
														<input class="btn btn-info" type="button" name="goto5" value="<#GO_5G#>" onclick="location.href='wireless5g_acl.asp';" />
													</td>
													<td style="border-top: 0 none;">
