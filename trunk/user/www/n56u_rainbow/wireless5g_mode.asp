...
function applyRule(){
	...
	if (validForm()){
		...
		document.form.current_page.value = "/wireless5g_mode.asp";
...
<div class="wrapper">
    ...
    <input type="hidden" name="current_page" value="wireless5g_mode.asp">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td width="50%" style="margin-top: 10px; border-top: 0 none;">
                                                <input class="btn btn-info" type="button"  value="<#GO_2G#>" onclick="location.href='wireless2g_mode.asp';">
                                            </td>
                                            <td style="border-top: 0 none;">
