...
<head>
	...
	<script>
		...
		function applyRule() {
			...
			document.form.current_page.value = "/aliyundrive.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
	...
	<div class="wrapper">
		...
		<form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
			<input type="hidden" name="current_page" value="aliyundrive.asp">
										...
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"class="table">
												...
												<tr>
													...
													<td id="aliyundrive_status" colspan="3">
													</td>
												</tr>
												<tr>
