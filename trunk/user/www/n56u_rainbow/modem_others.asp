    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/modem_others.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            <input type="hidden" name="current_page" value="modem_others.asp">
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                            ...
                                            <table class="table" id="tbl_modem_base" style="display:none">
                                                ...
                                                <tr>
                                                    <th style="padding-bottom: 0px;">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,21,4);">MTU:</a>
                                                    </th>
                                            ...
                                            <table class="table" id="tbl_modem_dns" style="display:none">
                                                ...
                                                <tr id="row_wan_dns2">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,21,7);"><#IPConnection_x_DNSServer1_itemname#> 2:</a>
                                                    </th>
                                                    <td>
