...
function applyRule(){
	...
	if(validForm()){
		...
		document.form.current_page.value = "/wireless5g_general.asp";
...
<div class="wrapper">
    ...
    <input type="hidden" name="current_page" value="wireless5g_general.asp">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td width="50%" style="margin-top: 10px; border-top: 0 none;">
                                                <input type="button" class="btn btn-info" value="<#GO_2G#>" onclick="location.href='wireless2g_general.asp';">
                                            </td>
                                            <td style="border-top: 0 none;">
