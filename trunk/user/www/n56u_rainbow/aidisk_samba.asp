		...
		function onEvent() {
			...
			if ((AM_to_cifs == 2 || AM_to_cifs == 4) && accounts.length < 50) {
				...
				$("createAccountBtn").onclick = function () {
					popupWindow('OverlayMask', '/aidisk/pop_createaccount.asp');
				};
			...
			if (this.accounts.length > 0 && this.selectedAccount.length > 0 && this.selectedAccount != "anonymous") {
				...
				$("deleteAccountBtn").onclick = function () {
					...
					popupWindow('OverlayMask', '/aidisk/pop_deleteaccount.asp');
				};
				...
				$("modifyAccountBtn").onclick = function () {
					...
					popupWindow('OverlayMask', '/aidisk/pop_modifyaccount.asp');
				};
			...
			if (this.selectedPool.length > 0) {
				...
				$("createFolderBtn").onclick = function () {
					...
					popupWindow('OverlayMask', '/aidisk/pop_createfolder.asp');
				};
			...
			if (this.selectedFolder.length > 0) {
				...
				$("deleteFolderBtn").onclick = function () {
					...
					popupWindow('OverlayMask', '/aidisk/pop_deletefolder.asp');
				};
				...
				$("modifyFolderBtn").onclick = function () {
					...
					popupWindow('OverlayMask', '/aidisk/pop_modifyfolder.asp');
				};
												...
												<table cellpadding="2" cellspacing="0" class="table t-border-top-none"
													...
													<tr>
														...
														<td width="35%" style="vertical-align: top;">
															<i id="createAccountBtn" class="if if-ftp-user-add"
																hspace="1" title="<#AddAccountTitle#>">
															</i>
															<i id="deleteAccountBtn" class="if if-ftp-user-del"
																hspace="1" title="<#DelAccountTitle#>">
															</i>
															<i id="modifyAccountBtn" class="if if-ftp-user-edit"
																hspace="1" title="<#ModAccountTitle#>">
															</i>
														</td>

														<!-- The action buttons of folders. -->
														<td>
															<i id="createFolderBtn" class="if if-ftp-folder-add"
																hspace="1" title="<#AddFolderTitle#>">
															</i>
															<i id="deleteFolderBtn" class="if if-ftp-folder-del"
																hspace="1" title="<#DelFolderTitle#>">
															</i>
															<i id="modifyFolderBtn" class="if if-ftp-folder-edit"
																hspace="1" title="<#ModFolderTitle#>">
															</i>
														</td>
													</tr>
												</table>
											...
											<table cellpadding="0" cellspacing="1" class="table" style="height: 500px;">
												<tr>
													...
													<td style="vertical-align: top;">
														...
														<!-- the tree of folders -->
														<div id="e0" class="FdTemp"
															style="font-size:9pt; margin-top:1px;"></div>

														<div
															style="text-align:right; margin:10px auto; border-top:1px dotted #CCC; width:95%; padding:2px;">
															<center>
																<input name="changePermissionBtn" id="changePermissionBtn" type="button" value="<#CTL_apply#>" class="btn btn-primary" style="width: 219px" disabled="disabled" />
															</center>
														</div>
													</td>
												</tr>
