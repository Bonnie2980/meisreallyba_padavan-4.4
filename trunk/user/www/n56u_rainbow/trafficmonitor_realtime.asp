...
<head>
	...
	<script>
		...
		function switchPage(id) {
			if (id == "tab_bw_24")
				location.href = "/trafficmonitor_last24.asp";
									...
									<div class="row-fluid">
										...
										<div style="margin-bottom: 0px; margin: -36px 0px 0px 0px;">
											<ul id="tabs" class="nav nav-tabs">
												<li class="active"><a href="javascript:void(0)" id="tab_bw_rt">
														<#menu4_2_1#>
													</a></li>
												<li><a href="javascript:void(0)" id="tab_bw_24">
														<#menu4_2_2#>
													</a></li>
