    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/ddns.asp";
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr id="row_ddns_server">
                                                    ...
                                                    <td>
                                                        <select name="ddns_server_x" class="input" onchange="change_ddns_server(1)"></select>
                                                        &nbsp;
                                                        <a id="ddns_link" href="javascript:openLink('x_DDNSServer')" class="label label-info" name="x_DDNS_link">
                                                ...
                                                <tr id="row_ddns_hname1">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,3);"><#LANHostConfig_x_DDNSHostNames_itemname#></a>
                                                    </th>
                                                    <td>
                                                        ...
                                                        <div id="asusddnsname_input" style="display:none;">
                                                            <input type="text" name="DDNSName" id="DDNSName" style="width: 110px;" placeholder="<#asusddns_inputhint#>" />
                                                            .asuscomm.com&nbsp;&nbsp;
                                                ...
                                                <tr id="row_ddns_user">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,1);"><#LANHostConfig_x_DDNSUserName_itemname#></a>
                                                    </th>
                                                    <td>
                                                ...
                                                <tr id="row_ddns_pass">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,2);"><#LANHostConfig_x_DDNSPassword_itemname#></a>
                                                    </th>
                                                    <td>
                                                ...
                                                <tr id="row_ddns_wcard">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,4);"><#LANHostConfig_x_DDNSWildcard_itemname#></a>
                                                    </th>
                                                    <td>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="ddns2_server" class="input" onchange="change_ddns2_server(1)"></select>
                                                        &nbsp;
                                            ...
                                            <table class="table">
                                                <tr>
                                                    <td style="border-top: 0 none;">
                                                        <center>
                                                            <input type="button" class="btn btn-primary" style="width: 219px" value="<#CTL_apply#>" onclick="applyRule();" />
                                                        </center>
                                                    </td>
                                                </tr>
                                            </table>
