...
function show_banner(L3) {
	...
	bc += '    <td><a href="/upgrade.asp"><span id="firmver" class="time"></span></a></td>\n';
	bc += '  </tr>\n';
	bc += '  <tr>\n';
	...
	bc += '    <td><button type="button" id="logout_btn" class="btn btn-mini" style="height: 21px; outline:0;" title="<#t1Logout#>" onclick="logout();"><i class="if if-banner-signout"></i></button> <button type="button" id="reboto_btn" class="btn btn-mini" style="height: 21px; outline:0;" title="<#BTN_REBOOT#>" onclick="reboot();"><i class="if if-banner-restart"></i></button> <button type="button" id="freememory_trash" class="btn btn-mini" style="height: 21px; outline:0;" title="<#BTN_FREEMEMORY#>" onclick="freememory();"><i class="if if-banner-cleanmemo"></i></button><div class="btn-group theme pull-left"><button type="button" class="btn btn-mini dropdown-toggle" data-toggle="dropdown"><i class="if if-banner-theme"></i></button><ul class="dropdown-menu" role="menu"><li class="red"><a href="#"></a></li><li class="orange"><a href="#"></a></li><li class="yellow"><a href="#"></a></li><li class="green"><a href="#"></a></li><li class="cyan"><a href="#"></a></li><li class="blue"><a href="#"></a></li><li class="purple"><a href="#"></a></li></ul></div></td>\n';
	bc += '  </tr>\n';
	bc += '</table>\n';
	bc += '</div>\n';
	bc += '</div>\n';
...
var tabM0 = [{
	"title": "<#menu5_1_1#>",
	"link": "wireless2g_general.asp"
}, {
	"title": "<#menu5_1_2#>",
	"link": "wireless2g_guest.asp"
}, {
	"title": "<#menu5_1_3#>",
	"link": "wireless2g_mode.asp"
}, {
	"title": "<#menu5_1_4#>",
	"link": "wireless2g_acl.asp"
}, {
	"title": "<#menu5_1_5#>",
	"link": "wireless2g_security.asp"
}, {
	"title": "<#menu5_1_6#>",
	"link": "wireless2g_advanced.asp"
}];
var tabM1 = [{
	"title": "<#menu5_1_1#>",
	"link": "wireless5g_general.asp"
}, {
	"title": "<#menu5_1_2#>",
	"link": "wireless5g_guest.asp"
}, {
	"title": "<#menu5_1_3#>",
	"link": "wireless5g_mode.asp"
}, {
	"title": "<#menu5_1_4#>",
	"link": "wireless5g_acl.asp"
}, {
	"title": "<#menu5_1_5#>",
	"link": "wireless5g_securit.asp"
}, {
	"title": "<#menu5_1_6#>",
	"link": "wireless5g_advanced.asp"
}];
var tabM2 = [{
	"title": "<#menu5_2_1#>",
	"link": "lan.asp"
...
var tabM5 = [{
	"title": "<#menu5_4_3#>",
	"link": "aidisk_others.asp"
}, {
	"title": "<#menu5_4_1#>",
	"link": "aidisk_samba.asp"
}, {
	"title": "<#menu5_4_2#>",
	"link": "aidisk_ftp.asp"
}, {
	"title": "<#menu5_4_4#>",
	"link": "modem_others.asp"
}, {
	"title": "<#menu5_4_5#>",
	"link": "printer_others.asp"
}];
var tabM6 = [{
	"title": "<#menu5_6_2#>",
	"link": "system.asp"
...
var tabM8 = [{
	"title": "<#menu5_11#>",
	"link": "wireless2g_status.asp"
}, {
	"title": "<#menu5_12#>",
	"link": "wireless5g_status.asp"
}, {
	"title": "",
	"link": ""
}, //interfaces_status.asp#0
{
	"title": "",
	"link": ""
}, {
...
var tabM9 = [{
	...
	"title": "<#menu5_7_3#>",
	"link": "dhcp_status.asp"
}, {
	"title": "<#menu5_7_5#>",
	"link": "upnp_status.asp"
}, {
	"title": "<#menu5_7_6#>",
	"link": "router_status.asp"
}, {
	"title": "<#menu5_7_8#>",
	"link": "connection_status.asp"
}];
...
menuL1.push({
	"title": "<#menu4#>",
	"link": "trafficmonitor_realtime.asp",
	"icon": "if-m1-netmonitor"
});
menuL1.push({
	"title": "<#menu5_8#>",
	"link": "system_info.asp",
	"icon": "if-m1-sysinfo"
});
menuL1.push({
	"title": "<#menu5#>",
...
var menuL2 = [{
	...
	"title": "<#menu5_9#>",
	"link": support_2g_radio() ? tabMenuHash.get('if-m2-netinfo')[0].link : "interfaces_status.asp",
	"icon": "if-m2-netinfo"
}, {
	"title": "<#menu5_7#>",
	...
	for (var i = 0; i < num_ephy; i++) {
		if (i == 0)
			tabMenuHash.get('if-m2-netinfo')[i + 2] = {
				"title": "WAN",
				"link": "interfaces_status.asp#" + i.toString()
			};
		else
			tabMenuHash.get('if-m2-netinfo')[i + 2] = {
...
function go_setting(band) {
	if (band == "2")
		location.href = "wireless2g_general.asp";
	else
		location.href = "wireless5g_general.asp";
}

function go_wguest(band) {
	if (band == "2")
		location.href = "wireless2g_guest.asp";
	else
		location.href = "wireless5g_guest.asp";
}
...
function show_time() {
	...
	$('systemtime').innerHTML = "<a href='/system.asp'>" + JS_timeObj3 + "</a>";
...
function logout() {
	if (!confirm('<#JS_logout#>'))
		return;
	setTimeout('location = "signout.asp";', 1);
}
...
function click_info_cpu() {
	location.href = "/system_info.asp#CPU";
}

function click_info_mem() {
	location.href = "/system_info.asp#MEM";
}
