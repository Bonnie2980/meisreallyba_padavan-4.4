...
function applyRule(){
	...
	if (validForm()){
		...
		document.form.current_page.value = "/wireless2g_mode.asp";
...
<div class="wrapper">
    ...
    <input type="hidden" name="current_page" value="wireless2g_mode.asp">
                                        ...
                                        <tr id="row_wds_apc" style="display:none;">
                                            ...
                                            <td>
                                                ...
                                                <div class="input-append" style="float: left;">
                                                    ...
                                                    <button class="btn btn-chevron" id="ctl_wds_2" type="button" onclick="pullLANIPList(this);" title="Select the Access Point"><i class="if if-btn-down"></i></button>
                                                </div>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td id="col_goto5" width="50%" style="margin-top: 10px; border-top: 0 none;">
                                                <input class="btn btn-info" type="button" name="goto5" value="<#GO_5G#>" onclick="location.href='wireless5g_mode.asp';">
                                            </td>
                                            <td style="border-top: 0 none;">
