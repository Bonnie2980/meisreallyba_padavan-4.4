    ...
    <script>
        ...
        function applyRule() {
            if (validForm()) {
                ...
                document.form.current_page.value = "/urlfilter.asp";
...
<body onload="initial();" onunLoad="return unload_body();">
    ...
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            ...
            <input type="hidden" name="next_page" value="urlfilter.asp">
                                ...
                                <div class="box well grad_colour_dark_blue">
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_urlf_main" style="display:none">
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="controls">
                                                            <label class="checkbox inline"><input type="checkbox" name="url_date_x_Mon" class="input"
                                                                    onChange="return changeDate();">
                                                                <#DAY_Mon#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" name="url_date_x_Tue" class="input"
                                                                    onChange="return changeDate();">
                                                                <#DAY_Tue#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" name="url_date_x_Wed" class="input"
                                                                    onChange="return changeDate();">
                                                                <#DAY_Wed#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" name="url_date_x_Thu" class="input"
                                                                    onChange="return changeDate();">
                                                                <#DAY_Thu#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" name="url_date_x_Fri" class="input"
                                                                    onChange="return changeDate();">
                                                                <#DAY_Fri#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" name="url_date_x_Sat" class="input"
                                                                    onChange="return changeDate();">
                                                                <#DAY_Sat#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox" name="url_date_x_Sun" class="input"
                                                                    onChange="return changeDate();">
                                                                <#DAY_Sun#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <input type="text" maxlength="2" class="input" style="width: 25px;" size="2" name="url_time_x_starthour"
                                                            onKeyPress="return is_number(this,event);">:
                                                        <input type="text" maxlength="2" class="input" style="width: 25px;" size="2" name="url_time_x_startmin"
                                                            onKeyPress="return is_number(this,event);">-
                                                        <input type="text" maxlength="2" class="input" style="width: 25px;" size="2" name="url_time_x_endhour"
                                                            onKeyPress="return is_number(this,event);">:
                                                        <input type="text" maxlength="2" class="input" style="width: 25px;" size="2" name="url_time_x_endmin"
                                                            onKeyPress="return is_number(this,event);">
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <button class="btn" type="submit" onClick="if(validForm()){return markGroup(this, 'UrlList', 128, ' Add ');}" name="UrlList">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align:top">
                                                        <button class="btn btn-danger" type="submit" onClick="return markGroup(this, 'UrlList', 128, ' Del ');" name="UrlList">
                                                            <i class="if if-btn-minus"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                            </table>
