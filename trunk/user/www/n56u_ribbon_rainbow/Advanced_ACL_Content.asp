								...
								<div class="box well grad_colour_dark_blue">
									...
									<div class="round_bottom">
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr>
													...
													<td style="border-top: 0 none;">
														<select name="wl_macmode" class="input"
															onchange="change_mac_enabled();">
															<option value="disabled" <%
																nvram_match_x("","wl_macmode", "disabled" ,"selected");
																%>><#CTL_Disabled#>
															</option>
															<option value="allow" <%
																nvram_match_x("","wl_macmode", "allow" ,"selected"); %>>
																<#FirewallConfig_MFMethod_item1#>
															</option>
															<option value="deny" <%
																nvram_match_x("","wl_macmode", "deny" ,"selected"); %>>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												class="table table-list" id="ACLList_Block">
												<tr>
													...
													<td width="35%">
														...
														<div class="input-append">
															<input type="text" maxlength="12" class="span12" size="12"
																name="wl_maclist_x_0" value="<% nvram_get_x("", "
																wl_maclist_x_0"); %>" onKeyPress="return
															is_hwaddr(event);" style="float:left; width: 175px"/>
															<button class="btn btn-chevron" id="chevron" type="button"
																onclick="pullLANIPList(this);"
																title="Select the MAC of WiFi clients"><i
																	class="if if-btn-down"></i></button>
														</div>
													</td>
													<td width="60%">
														<input type="text" maxlength="32" class="span12" size="32"
															name="wl_macdesc_x_0" value="<% nvram_get_x("", "
															wl_macdesc_x_0"); %>" onKeyPress="return
														is_string(this,event);" />
													</td>
													<td width="5%">
														<button class="btn" style="max-width: 219px" type="submit"
															onclick="return markGroupACL(this, 32, ' Add ');"
															name="ACLList2" value="<#CTL_add#>" size="12"><i
																class="if if-btn-plus"></i></button>
													</td>
												</tr>
											</table>
											...
											<table class="table">
												<tr>
													<td width="50%" style="margin-top: 10px; border-top: 0 none;">
														<input class="btn btn-info" type="button" value="<#GO_2G#>"
															onclick="location.href='Advanced_ACL2g_Content.asp';">
													</td>
													<td style="border-top: 0 none;">
