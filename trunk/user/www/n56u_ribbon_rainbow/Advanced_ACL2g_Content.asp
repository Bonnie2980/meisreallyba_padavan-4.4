													...
													<td style="border-top: 0 none;">
														<select name="rt_macmode" class="input"
															...
															<option value="disabled" <%
																nvram_match_x("","rt_macmode", "disabled" ,"selected");
																%>><#CTL_Disabled#>
															</option>
															<option value="allow" <%
																nvram_match_x("","rt_macmode", "allow" ,"selected"); %>>
																<#FirewallConfig_MFMethod_item1#>
															</option>
															<option value="deny" <%
																nvram_match_x("","rt_macmode", "deny" ,"selected"); %>>
												...
												<tr>
													<td width="35%">
														...
														<div class="input-append">
															<input type="text" maxlength="12" class="span12" size="12"
																name="rt_maclist_x_0" value="<% nvram_get_x("", "
																rt_maclist_x_0"); %>" onKeyPress="return
													...
													<td width="60%">
														<input type="text" maxlength="32" class="span12" size="32"
															name="rt_macdesc_x_0" value="<% nvram_get_x("", "
															rt_macdesc_x_0"); %>" onKeyPress="return
														is_string(this,event);" />
													</td>
													<td width="5%">
														<button class="btn" style="max-width: 219px" type="submit"
															onclick="return markGroupACL(this, 32, ' Add ');"
															name="rt_ACLList2" value="<#CTL_add#>" size="12"><i
