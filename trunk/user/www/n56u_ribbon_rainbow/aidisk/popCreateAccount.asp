	...
	<form method="post" name="createAccountForm" action="create_account.asp" target="hidden_frame">
		<table width="90%" class="table well aidisk_table" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="text-align: right"><a href="javascript:void(0)" onclick="parent.hidePop('OverlayMask');"><i
							class="if if-btn-minus"></i></a></td>
			</tr>
			<tr valign="middle">
				<td colspan="2">
					<#AddAccountAlert#>
			...
			<tr>
				...
				<td><input class="input" name="account" id="account" type="text" maxlength="20" style="width: 150px;">
				</td>
			</tr>
			<tr>
				<th>
				...
				<td><input class="input" name="password" id="password" type="password" maxlength="20"
			...
			<tr>
				...
				<td><input class="input" name="confirm_password" id="confirm_password" type="password" maxlength="20"
						style="width: 150px;"></td>
			</tr>
			<tr>
				<td colspan="2" style="text-align: center"><input name="button" type="button" class="btn btn-primary"
						style="width: 170px;" onclick="applyRule();" value="<#CTL_add#>"></td>
			</tr>
		</table>
	</form>
</body>
