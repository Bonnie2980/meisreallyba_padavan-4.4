    ...
    <table width="100%" class="table well aidisk_table" cellpadding="0" cellspacing="0">
      <thead>
        <tr>
          <td width="95%">
            <b>
              <#DelFolderTitle#> <span id="selected_account"></span>
            </b>
          </td>
      ...
      <tbody>
        <tr>
          <td colspan="2" valign="middle">
            <#DelFolderAlert#> <b><span id="selected_Folder"></span></b>
          </td>
        </tr>

        <tr>
          <td width="30%" style="text-align: left;">
            <input id="Cancel" type="button" class="btn" onClick="parent.hidePop('OverlayMask');"
              value="<#CTL_Cancel#>">
          </td>
